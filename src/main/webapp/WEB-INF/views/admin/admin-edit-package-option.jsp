...
<html>
<head>
    <title>Edit Package Option</title>
            ...
            <div class="admin-main">
                <div class="admin-content-area">
                    <div class="admin-page-header">
                        <div>
                            <h1 class="admin-page-heading">Edit Package Option</h1>
                            <p class="admin-page-subheading mb-0">
                                Update an existing package option for your travel package.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="dashboard-panel modern-panel">
                                ...
                                <form action="${pageContext.request.contextPath}/admin/package-options/edit" method="post">
                                    <input type="hidden" name="optionId" value="${packageOptionForm.optionId}">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="submit" class="btn btn-primary admin-submit-btn">Update Package Option</button>
