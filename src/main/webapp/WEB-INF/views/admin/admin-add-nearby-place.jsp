            ...
            <div class="admin-main">
                <div class="admin-topbar">
                    <div class="admin-search-box">
                        <input type="text" class="admin-search-input" placeholder="Add nearby place..." />
                    </div>
                ...
                <div class="admin-content-area">
                    <div class="admin-page-header">
                        <div>
                            <h1 class="admin-page-heading">Add Nearby Place</h1>
                            <p class="admin-page-subheading mb-0">
                                Add a nearby place for a selected package.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="dashboard-panel modern-panel">
                                <form action="<%= request.getContextPath() %>/admin/nearby-places/add" method="post">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="submit" class="btn btn-success admin-submit-btn">Add Nearby Place</button>
